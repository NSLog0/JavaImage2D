...
public class JavaImage2D {
    ...
    public JavaImage2D() {
        ...
        String fileName = "C:\\Users\\BMC\\Documents\\GitHub\\JavaImage2D\\image\\r5.jpg";
        IplImage image = cvLoadImage(fileName);
        //CvMat db_image_1 = cvLoadImageM(fileName);
        //C:\Users\BMC\Documents\NetBeansProjects\Image\img\test.png
       ...
       // image = FindContours.apply(image, fileName);
        ...
        Show.ShowImage(image, "Show Origrnal Image", image.width());
